                      ...
                      <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center"><a href="{{ url("admin/theloai/sua/")."/"}}{{ $value->id }}"><button class="button btn-primary ">Sửa</button></a></td>
                            <td class="text-center"><a href="{{ url("admin/theloai/xoa/")."/"}}{{ $value->id }}"><button class="button btn-danger text-center">Xoá</button></a></td>
                          </tr>
                          @endforeach
