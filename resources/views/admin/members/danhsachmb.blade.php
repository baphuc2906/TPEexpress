                      ...
                      <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-capitalize">{{ $value->password }} </td>
                            <td class="text-center"><a href="{{ url("admin/member/xem/")."/"}}{{ $value->id }}"><button class="button btn-primary ">xem</button></a></td>
                            <td class="text-center"><a href="{{ url("admin/user/xoa/")."/"}}{{ $value->id }}"><button class="button btn-danger text-center">Xoá</button></a></td>
                          </tr>
                          @endforeach
